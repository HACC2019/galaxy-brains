...
urlpatterns = [
    ...
    path('potentialprojectpage/<project>/', views.potentialProjectPage, name='potentialProjectPage'),
    path('confirmation/<project>/', views.confirmation, name='confirmation'),
    path('approveproject/<project>', views.approveproject, name='approve'),
    path('projectlisting/', views.projectList, name='projectList'),
    path('potentialprojectslist/', views.potentialProjectsList, name='potentialProjectsList'),
    path('createproject/', views.createproject, name    ='createproject'),
